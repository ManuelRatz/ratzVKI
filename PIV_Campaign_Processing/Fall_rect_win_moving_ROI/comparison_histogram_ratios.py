...
for i in range(0, n_t):
    ...
    ax1.set_title('(64,32,24); (64,32,16)', fontsize = 10)
    ax2.set_title('(64,32); (64,32)', fontsize = 10)
    ax3.set_title('(64,32,16); (64,32,16)', fontsize = 10)
    ax4.set_title('(64,32,24); (64,32,24)', fontsize = 10)
    ax5.set_title('(64,32,32); (48,24,12)', fontsize = 10)
    ax6.set_title('(64,48,48); (48,24,12)', fontsize = 10)
    ...
    ax1.set_title('(64,32,24);\n (64,32,16)', fontsize = 10)
    ax2.set_title('(64,32);\n (64,32)', fontsize = 10)
    ax3.set_title('(64,32,16);\n (64,32,16)', fontsize = 10)
    ax4.set_title('(64,32,24);\n (64,32,24)', fontsize = 10)
    ax5.set_title('(64,32,32);\n (48,24,12)', fontsize = 10)
    ax6.set_title('(64,48,48);\n (48,24,12))', fontsize = 10)
