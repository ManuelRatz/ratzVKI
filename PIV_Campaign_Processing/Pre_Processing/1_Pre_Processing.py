...
Images_Name = 'R_h1_f750_1_p15'

# Folder in
Fol_In = 'D:\PIV_Processed\Images_Rotated'+os.sep + Images_Name + os.sep
# create output folder in case it doesn't exist
Fol_Out = 'D:\PIV_Processed\Images_Preprocessed'+os.sep + Images_Name + os.sep  
