...
#%% inputs
# folder = 'C:/Users/fiorini/Documents/DomenicoFIORINI/VKI_PHD/PROJECT/CURRENT_EXPERIMENTAL_CAMPAIGNS/20201022_testPressureEquivalence/test6'
folder = ''
#%% functions....
...
path_valve_p = folder +'R_h1_f1200_1_p12-utube-valve_p_001.lvm'
path_pressure= folder +'R_h1_f1200_1_p12-utube-pressure_001.lvm'
path_pressure_n= folder +'R_h1_f1200_1_p12-utube-pressure_n_001.lvm'
path_valve_n = folder +'R_h1_f1200_1_p12-utube-valve_n_001.lvm'
...
# [time, voltages]  = read_lvm(path_pressure_n)
# p_pressure_n      = [voltage*206.32187068310276-11.767651474219058 for voltage in voltages]

# # valves
[t_valve_p, v_valve_p]   = read_lvm(path_valve_p)
g_valve_p        = np.gradient(v_valve_p,t_valve_p)

# [t_valve_n, v_valve_n]   = read_lvm(path_valve_n)
# g_valve_n        = np.gradient(v_valve_n,t_valve_n)
