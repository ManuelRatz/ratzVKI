...
name_hor = 'comparison_images' + os.sep + 'window_comparison_horizontal'
name_ver = 'comparison_images' + os.sep + 'window_comparison_vertical'
...
for k in range(0, n_t):
    ...
    save_name = Gif_Fol_ver + 'circ_vs_lin_horizontal_%06d.jpg' %load_index
    fig.savefig(save_name, dpi = 400)
    images_hor.append(imageio.imread(save_name))
