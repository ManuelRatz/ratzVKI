...
settings.filepath_images = '..' + os.sep + 'fall_f_1000' + os.sep
# Folder for the outputs
settings.save_path = './Results_PIV/'
# Root name of the output Folder for Result Files
settings.save_folder_suffix = 'Test_1'
# Format and Image Sequence
settings.frame_pattern_a = 'f_1000.6d7bpswt.*.tif'
...
settings.windowsizes = (64, 32) # if longer than n iteration the rest is ignored
# The overlap of the interroagtion window for each pass.
settings.overlap = (32, 16)  # This is 50% overlap
...
settings.MinMax_U_disp = (-10000, 10000)
settings.MinMax_V_disp = (-10000, 10000)
# The second filter is based on the global STD threshold
settings.std_threshold = 5000  # threshold of the std validation
# The third filter is the median test (not normalized at the moment)
settings.median_threshold = 5000  # threshold of the median validation
