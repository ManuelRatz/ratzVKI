...
"""
Here different settings for the plots are given. For now this just regarding
the label sizes for every text, the grid, the font and the use of Latex
"""
...
for i in range(0, 3):
    ...
    #calculate the average height and contact angle
